...
CREATE TABLE clientes (
  ...
  numeroMiembros INTEGER DEFAULT NULL,
  testimonio VARCHAR(500) DEFAULT NULL
);

CREATE TABLE negociacion_colectiva (
  id BIGSERIAL PRIMARY KEY,
  cliente_id INTEGER NOT NULL,
  trabajadores_cubiertos INTEGER DEFAULT NULL,
  fecha_negociacion DATE DEFAULT NULL
);

CREATE TABLE negociacionesrealizadas (
  id SERIAL PRIMARY KEY,
  fecha DATE NOT NULL,
  clienteId INTEGER NOT NULL,
  CONSTRAINT negociacionesrealizadas_ibfk_1 FOREIGN KEY (clienteId) REFERENCES clientes (id)
);
...
INSERT INTO clientes 
  (actividad_economica, email, locality, logo, nombre, telefono, direccion, numeroMiembros, testimonio) 
VALUES
...
VALUES
  ...
  ('images/news/titutlo-dlef.jpg', '2025-08-02', 'El Ministerio del Trabajo lanzó un programa piloto para prevenir el acoso laboral en empresas de gran tamaño, incorporando protocolos de denuncia confidenciales y capacitaciones obligatorias.', 'programa-prevencion-acoso-laboral', 'El 2 de agosto de 2025, el Ministerio del Trabajo presentó un programa piloto que implementa medidas preventivas contra el acoso laboral. La iniciativa incluye talleres de capacitación obligatoria para empleados, canales confidenciales para denuncias y seguimiento de los casos reportados. Se espera que esta medida sirva como modelo para la regulación nacional.', 'Programa Piloto de Prevención del Acoso Laboral en Empresas', '2025-08-04');

INSERT INTO negociacionesrealizadas 
  (fecha, clienteId) 
VALUES
  ('2024-01-10', 1),
  ('2024-01-11', 2);
...
SELECT * FROM negociacion_colectiva;
SELECT * FROM negociacionesrealizadas;
